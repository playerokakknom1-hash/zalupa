...
class Filter(_message.Message):
    __slots__ = ("name", "comparison", "valueCase")
    NAME_FIELD_NUMBER: _ClassVar[int]
    COMPARISON_FIELD_NUMBER: _ClassVar[int]
    VALUECASE_FIELD_NUMBER: _ClassVar[int]
    name: str
    comparison: Comparison
    valueCase: Filter_ValueOneofCase
    def __init__(self, name: _Optional[str] = ..., comparison: _Optional[_Union[Comparison, _Mapping]] = ..., valueCase: _Optional[_Union[Filter_ValueOneofCase, str]] = ...) -> None: ...
